...
return [
	...
	*/
	...
	'boolean'              => 'ورودی :attribute فقط می‌تواند صحیح و یا غلط باشد',
	'confirmed'            => 'ورودی :attribute با تکرار آن مطابقت ندارد',
	...
	'distinct'             => 'ورودی :attribute تکراری است',
	'email'                => ':attribute باید یک ایمیل معتبر باشد',
	'exists'               => ':attribute انتخاب شده، معتبر نیست',
	'file'                 => ':attribute باید یک فایل باشد',
	'filled'               => 'ورودی :attribute الزامی است',
	'gt'                   => [
	...
	'present'              => 'ورودی :attribute باید در پارامترهای ارسالی وجود داشته باشد',
	'regex'                => 'فرمت :attribute معتبر نیست',
	'required'             => 'ورودی :attribute الزامی است',
	'required_if'          => 'هنگامی که :other برابر با :value است، ورودی :attribute الزامی است',
	'required_unless'      => 'ورودی :attribute ضروری است، مگر آنکه :other در :values موجود باشد',
	'required_with'        => 'در صورت وجود ورودی :values، ورودی :attribute الزامی است',
	'required_with_all'    => 'در صورت وجود ورودیهای :values، ورودی :attribute الزامی است',
	'required_without'     => 'در صورت عدم وجود ورودی :values، ورودی :attribute الزامی است',
	'required_without_all' => 'در صورت عدم وجود هر یک از ورودیهای :values، ورودی :attribute الزامی است',
	...
	'string'               => 'ورودی :attribute باید متن باشد',
	'timezone'             => 'ورودی :attribute باید یک منطقه زمانی قابل قبول باشد',
