...
class Configs
{
    ...
    public static function getShortcodesValues()
    {
        return array();
    }

    public static function getStyleApply()
    {
        return array(
            '.star-rating span' =>
                array(
    ...
    public static function getFontApply()
    {
        return array(
            0 => '.font-family',
            1 => '.uk-h1',
    ...
    public static function getGlobalCards()
    {
        return array(
            'blog-carousel' =>
                array(
