...
class Image_Slider extends Widget
{
    ...
    protected function register_controls(): void
    {
        ...
        $this->addStyleOptions(__('Slide Title', THEME_TEXTDOMAIN), '.slider-wrapper .swiper-slide{{mode}} .slider-title', 'slideTitle', [],
            [
                'opacity',
                'flex',
                'border',
        ...
        $this->addStyleOptions(__('Slide Description', THEME_TEXTDOMAIN), '.slider-wrapper .swiper-slide{{mode}} .slider-description', 'slideDescription', [],
            [
                'opacity',
                'flex',
                'border',
