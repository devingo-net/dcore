 ...
 * Class Group_Control_Query
 *
 * @package ElementorPro\Modules\QueryControl\Controls
 */
class Group_Control_Query extends \Elementor\Group_Control_Base
{
    ...
    protected function init_fields_by_name($name)
    {
        ...
        $fields['include_term_ids'] = [
            ...
            'description' => __('Terms are items in a taxonomy. The available taxonomies are: Categories, Tags, Formats and custom taxonomies.',
                'elementor-pro'),
            'type' => \ElementorPro\Modules\QueryControl\Module::QUERY_CONTROL_ID,
            'options' => [],
            'label_block' => true,
            'multiple' => true,
            'autocomplete' => [
                'object' => \ElementorPro\Modules\QueryControl\Module::QUERY_OBJECT_CPT_TAX,
                'display' => 'detailed',
            ],
            'group_prefix' => $name,
            'condition' => [
        ...
        $fields['avoid_duplicates'] = [
            ...
            'default' => '',
            'description' => __('Set to Yes to avoid duplicate posts from showing up. This only effects the frontend.',
                'elementor-pro'),
            'tabs_wrapper' => $tabs_wrapper,
            'inner_tab' => $exclude_wrapper,
            'condition' => [
        ...
        $fields['offset'] = [
            ...
            'description' => __('Use this setting to skip over posts (e.g. \'2\' to skip over 2 posts).',
                'elementor-pro'),
            'tabs_wrapper' => $tabs_wrapper,
            'inner_tab' => $exclude_wrapper,
        ];
        ...
        $fields['date_before'] = [
            ...
            'description' => __('Setting a ‘Before’ date will show all the posts published until the chosen date (inclusive).',
                'elementor-pro'),
        ];
        ...
        $fields['date_after'] = [
            ...
            'description' => __('Setting an ‘After’ date will show all the posts published since the chosen date (inclusive).',
                'elementor-pro'),
        ];
    ...
    private function filter_by_presets($presets, $fields)
    {
        ...
        $control_ids = array_merge(...array_values($presets));
    ...
    protected function prepare_fields($fields): array
    {
        ...
        $post_types = \ElementorPro\Core\Utils::get_public_post_types($post_type_args);
