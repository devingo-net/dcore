...
<div class="csf-welcome csf-welcome-wrap">
  ...
  <h1>به فریمورک codestar خوش آمدید v<?php echo esc_attr( CSF::$version ); ?></h1>

  <p class="csf-about-text">یک ابزار ساده و سبک برای ساخت پنل تنظیمات برای سایت یا افزونه های وردپرس</p>
