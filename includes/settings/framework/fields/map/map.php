  ...
  class CSF_Field_map extends CSF_Fields {
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'csf-leaflet' ) ) {
        wp_enqueue_script( 'csf-leaflet', esc_url( THEME_ASSETS_SCRIPT_URI .'leaflet.js' ), array( 'csf' ), $this->version, true );
      }

      if ( ! wp_style_is( 'csf-leaflet' ) ) {
        wp_enqueue_style( 'csf-leaflet', esc_url( THEME_ASSETS_STYLE_URI .'leaflet.css' ), array(), $this->version );
      }
